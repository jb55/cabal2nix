...
defaultConfiguration = Configuration
  ...
  , brokenPackages = Set.fromList $ map PackageName
    ...
    , "hlibev"
    , "hlibfam"
    , "hlibsass"                        -- https://github.com/jakubfijalkowski/hsass/issues/1
    , "HListPP"
    , "hlogger"
    , "HLogger"
    , "hly"
    ...
    , "hxthelper"
    , "hxweb"
    , "hyakko"                          -- https://github.com/sourrust/hyakko/issues/2
    , "hybrid"
    , "hybrid-vectors"
    , "hydra-hs"
    , "hydra-print"
    ...
    , "ihaskell-display"
    , "ihaskell-hatex"
    , "ihaskell"                -- https://github.com/gibiansky/IHaskell/issues/495
    ...
    , "MC-Fold-DP"
    , "mcmc-samplers"
    , "mdcat"                           -- https://github.com/dorafmon/mdcat/issues/2
    , "Measure"
    , "mecab"
    , "mediawiki"
    , "mediawiki2latex"
    ...
    , "panda"
    , "PandocAgda"
    , "pandoc-csv2table"                -- https://github.com/baig/pandoc-csv2table/issues/8
    , "pandoc-unlit"
    , "papillon"
    , "pappy"
    , "paragon"
    ...
    , "wai-static-cache"
    , "wai-throttler"
    , "waitra"                          -- https://github.com/futurice/waitra/issues/4
    , "warp-dynamic"
    , "warp-tls-uid"
    , "WashNGo"
    , "watchdog"
